...
public class MyBook {
	...
	public MyBook(String isbn, String title, String catalogue, String nation, String publish_date, String publisher,
	...
	public String toString() {
		return "MyBook [isbn=" + isbn + ", title=" + title + ", catalogue=" + catalogue + ", nation=" + nation
