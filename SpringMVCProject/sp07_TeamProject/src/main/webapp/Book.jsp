    ...
    <div id="entrance">
        ...
        <form action="addBook.do">
            ...
            <p>
                ...
                <span><input type="text" name="isbn" id="bookNo1" required> - <input type="text" name="bookNo" id="bookNo2" required> - <input type="text" name="bookNo" id="bookNo3" required></span>
            </p>
            <p>
            ...
            <p>
                ...
                <span>
                    <select name="catalogue" id="bookCategory">
                        <option>프로그래밍</option>
                        <option>운영체제</option>
            ...
            <p>
                ...
                <span>
                    <input type="radio" name="nation" id="bookCountry" value="국내도서"> 국내도서
                    <input type="radio" name="nation" id="bookCountry" value="외국도서"> 외국도서
                </span>
            </p>
            <p>
            ...
            <p>
                ...
                <span><input type="text" name="price" id="bookPrice">
                    <select name="currency" id="bookPrice2">
                        <option>원</option>
                        <option>달러</option>
                    </select>
                </span>
            ...
            <p>
                ...
                <textarea name="description" id="bookSummary" cols="40" rows="2"></textarea>
            </p>
            <p>
